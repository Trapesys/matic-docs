...
- gcloud CLI configured under the same project where the Polygon Edge product has been deployed. Click [here](https://cloud.google.com/sdk/docs/configurations) for configuration steps.
